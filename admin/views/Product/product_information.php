...
?>
        ...
        <div class="page-container">
		 ...
		 try {
            ...
            $query = "SELECT product.id, product.name,category.name as category_name,product.price,product.sale,product.content,product.quantity,product.hot,product.avatar,product.created_at FROM (product INNER JOIN category ON product.category_id = category.id )where product.id =   $id ";
					...
					<div class = "row card ">
					  ...
					  if ($result1)  {
						while ($row1 = $result1->fetch_array(MYSQLI_ASSOC)) {
							...
							<label class="col-4 d-flex  "> </label >     
                     ...
                     <label class="col-2" >khuyến mãi</label >                    
                      <td>:' .$sale. '%</td>              
                       ...
                       <div class="form-group row">                        
                     <label class="col-2" >Tên loại</label >                    
                       <td>:' .$category_name. '</td>
                     </div>
                     ...
                     <td>:' .$quantity. '</td>
                      ...
                      <div class="form-group row">
                     <label class="col-2" >Thời gian </label > 
                     <td>:' .$created_at. '</td>
                      </div>   
                     </div> 
                           </div>    
